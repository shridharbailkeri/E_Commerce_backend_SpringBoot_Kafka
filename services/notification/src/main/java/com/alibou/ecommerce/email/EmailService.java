...
public class EmailService {
    ...
    // when we get a notification and we want to send an email we dont want to block the whole process utill the email is sent @Async
    // enable async in main notification app
    @Async
